    ...
    <Section className={cn("group relative overflow-hidden", className)}>
      <div className="max-w-container relative z-10 mx-auto flex flex-col items-center gap-6 text-center sm:gap-8">
        ...
        <p className="text-muted-foreground max-w-[500px] text-lg">
          Drop the installer on your machine, show your pairing QR to a friend, say one password aloud, and start talking. There&apos;s nothing to sign up for — no servers, no accounts, nothing to install on their side either.
        </p>
